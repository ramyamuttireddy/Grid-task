            ...
            <div className="bg-[#f1eeee] h-screen w-screen flex items-center justify-center">
                ...
                <div className="grid  grid-cols-4 gap-4 m-auto w-[1000px]">
                    ...
                    <div className="bg-[#7650dc] col-span-2 text-center flex flex-col items-center justify-center  p-[2.5em] rounded-[10px] shadow-xl">
                        ...
                        <img src="src/assets/illustration-five-stars.webp" alt="" className='w-[280px] items-center mt-[18px] mb-[8px]' />
                    ...
                    <div className="bg-[#dacffc] row-span-3 p-[18px] rounded-[10px] overflow-hidden shadow-xl">
                       ...
                       <img src="src/assets/illustration-schedule-posts.webp" alt="" className='ml-[30px] w-[300px] h-[268px] my-[18px] object-fill' />
                    ...
                    <img src="src/assets/illustration-multiple-platforms.webp" alt="Social media links" className='w-[290px] h-[60px] ml-[30px]'/>
                    ...
                    <img src="src/assets/illustration-consistent-schedule.webp" alt="Calendar with marks" className='w-[177px] h-[133px] mt-[18px]  absolute bottom-[-60px]'/>
                    </div>
                    ...
                    <img src="src/assets/illustration-ai-content.webp" alt="Conversation"  className='w-[200px] h-[203px] mt-[27px]'/>
                    </div>
				...
				<img src="src/assets/illustration-audience-growth.webp" alt="People profile pictures"  className='w-[160px]'/>
                    </div>

                    {/* eight card */}

                    <div className="bg-[#7650dc] col-span-2 p-[18px] grid grid-cols-2 rounded-[10px] justify-center items-center shadow-xl">
                    <img src="src/assets/illustration-grow-followers.webp" alt="Graph with raising followers" />
